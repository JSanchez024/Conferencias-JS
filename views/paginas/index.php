...
<section class="speakers">
    <h2 class="speakers__heading">Speaker</h2>
        ...
        <?php foreach($ponentes as $ponente) {  ?>
            <div class="speaker">
                <picture>
                    ...
                    <img class="speaker__imagen" src="img/speakers/<?php echo $ponente->imagen; ?>.png" alt="Imagen Ponente" loading="lazy" width="200" height="300">
                </picture>
